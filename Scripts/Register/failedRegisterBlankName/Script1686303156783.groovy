...
Mobile.setText(findTestObject('pageRegister/inputName'), '', 0)
...
Mobile.verifyElementVisible(findTestObject('pageRegister/alertEnterName'), 0)

Mobile.verifyElementAttributeValue(findTestObject('pageRegister/alertEnterName'), 'text', 'Enter Full Name', 0)
