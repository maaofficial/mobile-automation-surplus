...
Mobile.setText(findTestObject('pageRegister/inputConfirmPassword'), GlobalVariable.password, 0)
...
Mobile.verifyElementVisible(findTestObject('pageRegister/alertEnterEmail'), 0)

Mobile.verifyElementAttributeValue(findTestObject('pageRegister/alertEnterEmail'), 'text', 'Enter Valid Email', 0)
