...
Mobile.verifyElementVisible(findTestObject('pageRegister/popUpSuccessRegistered'), 0)

Mobile.verifyElementAttributeValue(findTestObject('pageRegister/popUpSuccessRegistered'), 'text', 'Registration Successful', 
    0)
