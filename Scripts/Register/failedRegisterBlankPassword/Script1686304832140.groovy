...
Mobile.verifyElementVisible(findTestObject('pageRegister/alertEnterPassword'), 0)

Mobile.verifyElementAttributeValue(findTestObject('pageRegister/alertEnterPassword'), 'text', 'Enter Password', 0)
