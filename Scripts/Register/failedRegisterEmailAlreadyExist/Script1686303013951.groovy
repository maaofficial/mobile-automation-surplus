...
Mobile.verifyElementVisible(findTestObject('pageRegister/alertEmailExist'), 0)

Mobile.verifyElementAttributeValue(findTestObject('pageRegister/alertEmailExist'), 'text', 'Email Already Exists', 0)
